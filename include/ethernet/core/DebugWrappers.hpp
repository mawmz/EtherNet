...
#include <engine/xc2/fw/Debug.hpp>
#include <engine/xc2/game/Utils.hpp>
#include <engine/xc2/gf/Util.hpp>
#include <engine/xc2/ml/DebugDrawing.hpp>

namespace ethernet::core::debug {
	...
	inline void drawFontFmt3D(const mm::Vec3 pos, const mm::Col4& color, const FormatString& format, Args&&... args) {
		...
		if (ethernet::core::DocumentPtr == nullptr)
			return;

		if (game::CameraUtil::calcScreenPos(reinterpret_cast<mm::Vec3&>(screenPoint), *ethernet::core::DocumentPtr, pos))
#endif
